...
class Product extends DatabaseConfig {
    ...
    public function findById($id) {
        $sql = "SELECT * FROM gaming_laptop WHERE id = ?";
    ...
    public function create($data) {
        ...
        $query = "INSERT INTO gaming_laptop (product_name) VALUES (?)"; // Gunakan 'product_name'
    ...
    public function update($id, $data) {
        ...
        $query = "UPDATE gaming_laptop SET product_name = ? WHERE id = ?";
        $stmt = $this->conn->prepare($query);
    ...
    public function delete($id) {
        $query = "DELETE FROM gaming_laptop WHERE id = ?";
        $stmt = $this->conn->prepare($query);
